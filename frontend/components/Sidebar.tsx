        ...
        <aside className={cn(
            ...
            <div className="p-6 relative z-10 flex flex-col h-full">
                <div className="flex items-center gap-4 mb-10 group cursor-pointer">
                    <div className="relative w-14 h-14 rounded-2xl overflow-hidden border-0 ring-0 bg-transparent group-hover:rotate-3 transition-all duration-500">
                        <Image src="/ceo-logo.jpeg" alt="Hugamara" fill className="object-contain" sizes="56px" quality={100} priority />
                    </div>
                    <div>
